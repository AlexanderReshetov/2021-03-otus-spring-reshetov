...
public class GenreServiceImpl implements GenreService {
    ...
    @Transactional
    public void saveAll(List<ResponseGenreDto> responseGenreDtoList) {
        genreRepository.saveAll(responseGenreDtoList.stream().map(ResponseGenreDto :: toDomain).collect(Collectors.toList()));
    }
}
