insert into author (id, name) values (1, 'LibraryAuthor1');
insert into author (id, name) values (2, 'LibraryAuthor2');
...
insert into user(id, login, password) values(1, 'reader', '$2a$10$upDS8XmWIPHBpnAI7K6sL.Iqueo1F68KoJocGXWue3kIY/.sbxele'); -- pwd
insert into user(id, login, password) values(2, 'admin', '$2a$10$V2QtN/sA9cenfuhqiv62wuGmQEik.jTHNaIG8Q1D37hIptZfSijjC'); -- password
insert into user(id, login, password) values(3, 'commentator', '$2a$10$QBzwtQPnbLpEdxbK45HFBOABcQmB4rfsy7cV.gwx6sXHyp369N1Ya'); -- pass
insert into role(id, name) values(1, 'ROLE_ADMIN');
insert into role(id, name) values(2, 'ROLE_READER');
insert into role(id, name) values(3, 'ROLE_COMMENTATOR');
