...
public class AuthorServiceImplTest {
    ...
    void shouldGetAuthorById() {
        final Author author = new Author(1L, "LibraryAuthor1");
    ...
    @Test
    @DisplayName("сохранить список авторов")
    void shouldSaveAuthorList() {
        authorService.saveAll(Collections.singletonList(new ResponseAuthorDto(1L, "TestAuthor")));
